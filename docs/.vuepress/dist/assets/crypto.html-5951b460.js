import{_ as a,o as s,c as n,a as t}from"./app-e9c68afe.js";const e={},o=t(`<h1 id="crypto" tabindex="-1"><a class="header-anchor" href="#crypto" aria-hidden="true">#</a> crypto</h1><h2 id="hashalgorithm" tabindex="-1"><a class="header-anchor" href="#hashalgorithm" aria-hidden="true">#</a> HashAlgorithm</h2><div class="language-buzz" data-ext="buzz"><pre class="language-buzz"><code><span class="token keyword">enum</span> <span class="token class-name">HashAlgorithm</span> <span class="token punctuation">{</span>
