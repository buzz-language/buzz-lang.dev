...
</code></pre></div><p>When the value type is <code>str</code>, you can omit case values which will be the same as the case name.</p><div class="language-buzz" data-ext="buzz"><pre class="language-buzz"><code><span class="token keyword">enum</span><span class="token punctuation">(</span><span class="token keyword">str</span><span class="token punctuation">)</span> <span class="token class-name">Locale</span> <span class="token punctuation">{</span>
...
</code></pre></div><p>If one case value is specified <strong>all</strong> cases must also have a value.</p>`,11),p=[o];function c(u,l){return a(),s("div",null,p)}const i=n(t,[["render",c],["__file","enums.html.vue"]]);export{i as default};
