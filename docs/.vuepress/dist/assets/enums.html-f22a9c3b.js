...
<span class="token keyword">final</span> lang <span class="token operator">=</span> <span class="token class-name">Lang</span><span class="token punctuation">{</span>
...
</code></pre></div>`,13),p=[o];function c(u,l){return a(),s("div",null,p)}const r=n(e,[["render",c],["__file","enums.html.vue"]]);export{r as default};
