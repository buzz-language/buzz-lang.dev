import{_ as n,o as s,c as a,a as t}from"./app-abc9d1dc.js";const p={},o=t(`<h1 id="errors" tabindex="-1"><a class="header-anchor" href="#errors" aria-hidden="true">#</a> Errors</h1><p>Functions must specify which error they can raise with <code>!&gt; type1, type2, ...</code>. Error can&#39;t be raised in the global scope. <code>test</code> functions ignore errors.</p><div class="language-buzz" data-ext="buzz"><pre class="language-buzz"><code><span class="token keyword">enum</span><span class="token punctuation">(</span><span class="token keyword">str</span><span class="token punctuation">)</span> <span class="token class-name">MyErrors</span> <span class="token punctuation">{</span>
