import{_ as n,o as s,c as a,a as e}from"./app-9a3cec5f.js";const p={},t=e(`<h1 id="errors" tabindex="-1"><a class="header-anchor" href="#errors" aria-hidden="true">#</a> errors</h1><h2 id="filesystemerror" tabindex="-1"><a class="header-anchor" href="#filesystemerror" aria-hidden="true">#</a> FileSystemError</h2><div class="language-buzz" data-ext="buzz"><pre class="language-buzz"><code><span class="token keyword">enum</span> <span class="token class-name">FileSystemError</span> <span class="token punctuation">{</span>
